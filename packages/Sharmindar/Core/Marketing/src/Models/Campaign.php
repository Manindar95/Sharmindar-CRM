...
namespace Sharmindar\Core\Marketing\Models;

use Illuminate\Database\Eloquent\Model;
use Sharmindar\Core\EmailTemplate\Models\EmailTemplateProxy;
use Sharmindar\Core\Marketing\Contracts\Campaign as CampaignContract;

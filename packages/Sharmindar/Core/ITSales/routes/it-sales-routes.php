...
use Sharmindar\Core\ITSales\Http\Controllers\ServiceController;
use Sharmindar\Core\ITSales\Http\Controllers\ProposalController;
use Sharmindar\Core\ITSales\Http\Controllers\RequirementController;
use Sharmindar\Core\ITSales\Http\Controllers\EstimationController;
use Sharmindar\Core\ITSales\Http\Controllers\ApprovalController;
use Sharmindar\Core\ITSales\Http\Controllers\ProjectHandoverController;
use Sharmindar\Core\ITSales\Http\Controllers\LeadExtensionController;
use Sharmindar\Core\ITSales\Http\Controllers\LeadAttachmentController;
use Sharmindar\Core\ITSales\Http\Controllers\LeadLifecycleController;

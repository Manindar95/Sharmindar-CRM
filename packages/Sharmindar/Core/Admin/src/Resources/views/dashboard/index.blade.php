<x-admin::layouts>
    ...
    <div class="mt-3.5 flex gap-4 max-xl:flex-wrap">
        ...
        <div class="flex flex-1 flex-col gap-4 max-xl:flex-auto w-full">
            <!-- ENGINE DYNAMIC WIDGETS -->
             @if(isset($widgets) && $widgets->count() > 0)
                <div class="mb-4 w-full">
                    <p class="mb-2 text-lg font-bold text-gray-800 dark:text-white">Active Modules</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 w-full">
                        @foreach($widgets as $widget)
                            @php
                                $colSpanClass = 'col-span-1';
                                if ($widget->getWidth() === 'full') $colSpanClass = 'col-span-1 md:col-span-2 lg:col-span-3 xl:col-span-4';
                                else if ($widget->getWidth() === 'half') $colSpanClass = 'col-span-1 md:col-span-2';
                                else if ($widget->getWidth() === 'third') $colSpanClass = 'col-span-1 md:col-span-2 lg:col-span-3';
                            @endphp

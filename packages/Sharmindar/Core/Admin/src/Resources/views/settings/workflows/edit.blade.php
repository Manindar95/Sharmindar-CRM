    ...
    @pushOnce('scripts')
        ...
        <script type="module">
            app.component('v-workflow', {
                ...
                data() {
                    return {
                        events: @json(app('\Sharmindar\Core\Automation\Helpers\Entity')->getEvents()),
        ...
        <script type="module">
            app.component('v-workflow-condition-item', {
                ...
                data() {
                    return {
                        conditions: @json(app('\Sharmindar\Core\Automation\Helpers\Entity')->getConditions()),
        ...
        <script type="module">
            app.component('v-workflow-action-item', {
                ...
                data() {
                    return {
                        actions: @json(app('\Sharmindar\Core\Automation\Helpers\Entity')->getActions()),
                    };
                },

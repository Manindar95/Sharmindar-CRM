@php
    $quote = app('\Sharmindar\Core\Quote\Repositories\QuoteRepository')->getModel();
                ...
                <div class="flex flex-col gap-4 px-4 py-2">
                    ...
                    >
                        ...
                        <div class="w-1/2 max-md:w-full">
                            <x-admin::attributes
                                :custom-attributes="app('Sharmindar\Core\Attribute\Repositories\AttributeRepository')->findWhere([
                                    'entity_type' => 'quotes',
                                    ['code', 'IN', ['subject']],
                                ])"
                            ...
                            <div class="flex gap-4">
                                ...
                                @php
                                    $lookUpEntityData = app('Sharmindar\Core\Attribute\Repositories\AttributeRepository')->getLookUpEntity('leads', request('lead_id'));
                                @endphp

...
namespace Sharmindar\Core\Admin\Http\Controllers\Lead;
...
use Sharmindar\Core\Admin\DataGrids\Lead\LeadDataGrid;
use Sharmindar\Core\Admin\Http\Controllers\Controller;
use Sharmindar\Core\Admin\Http\Requests\LeadForm;
use Sharmindar\Core\Admin\Http\Requests\MassDestroyRequest;
use Sharmindar\Core\Admin\Http\Requests\MassUpdateRequest;
use Sharmindar\Core\Admin\Http\Resources\LeadResource;
use Sharmindar\Core\Admin\Http\Resources\StageResource;
use Sharmindar\Core\Attribute\Repositories\AttributeRepository;
use Sharmindar\Core\Contact\Repositories\PersonRepository;
use Sharmindar\Core\Lead\Helpers\MagicAI;
use Sharmindar\Core\Lead\Repositories\LeadRepository;
use Sharmindar\Core\Lead\Repositories\PipelineRepository;
use Sharmindar\Core\Lead\Repositories\ProductRepository;
use Sharmindar\Core\Lead\Repositories\SourceRepository;
use Sharmindar\Core\Lead\Repositories\StageRepository;
use Sharmindar\Core\Lead\Repositories\TypeRepository;
use Sharmindar\Core\Lead\Services\MagicAIService;
use Sharmindar\Core\Tag\Repositories\TagRepository;

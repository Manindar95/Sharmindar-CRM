...
namespace Sharmindar\Core\Admin\Http\Controllers\Timesheet;

use Illuminate\Http\JsonResponse;
use Illuminate\View\View;
use Sharmindar\Core\Admin\DataGrids\Timesheet\TimesheetDataGrid;
use Sharmindar\Core\Admin\Http\Controllers\Controller;
use Sharmindar\Core\Admin\Models\Timesheet;
use Sharmindar\Core\Admin\Models\Project;
use Sharmindar\Core\Admin\Models\Task;
...
class TimesheetController extends Controller
{
    public function index(): View|JsonResponse
    {
        ...
        $users = \Sharmindar\Core\User\Models\User::pluck('name', 'id');

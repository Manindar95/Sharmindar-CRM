...
Route::prefix('settings')->group(function () {
     ...
     */
        Route::controller(\Sharmindar\Core\Setting\Http\Controllers\SecurityController::class)->prefix('security')->group(function () {
            Route::get('', 'index')->name('admin.user.security.index');
            Route::post('2fa/enable', 'enableTwoFactor')->name('admin.user.security.2fa.enable');
            Route::delete('2fa/disable', 'disableTwoFactor')->name('admin.user.security.2fa.disable');
            Route::delete('session/{id}', 'revokeSession')->name('admin.user.security.session.revoke');
            Route::delete('sessions/other', 'revokeOtherSessions')->name('admin.user.security.session.revoke_others');
        }
        );

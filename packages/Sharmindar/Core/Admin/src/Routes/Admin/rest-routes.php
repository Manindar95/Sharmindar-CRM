...
/**
 * Global Search Engine routes.
 */
Route::controller(\Sharmindar\Core\Dashboard\Http\Controllers\GlobalSearchController::class)->prefix('global-search')->group(function () {
    Route::get('users', 'searchUsers')->name('admin.global_search.users');
    Route::get('projects', 'searchProjects')->name('admin.global_search.projects');
    Route::get('tasks', 'searchTasks')->name('admin.global_search.tasks');
    Route::get('clients', 'searchClients')->name('admin.global_search.clients');
});

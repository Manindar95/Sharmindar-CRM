...
namespace Sharmindar\Core\Admin\DataGrids\Lead;
...
class LeadDataGrid extends DataGrid
{
     ...
     * Pipeline instance.
     *
     * @var \Sharmindar\Core\Contract\Repositories\Pipeline
     */
    protected $pipeline;
    ...
    public function prepareColumns(): void
    {
        ...
        $this->addColumn([
            ...
            'filterable_type'    => 'searchable_dropdown',
            'filterable_options' => [
                'repository' => \Sharmindar\Core\Contact\Repositories\PersonRepository::class,
                'column'     => [
                    'label' => 'name',
                    'value' => 'name',
                ],

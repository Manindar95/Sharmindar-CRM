...
namespace Sharmindar\Core\Admin\Traits;
...
trait ProvideDropdownOptions
{
    ...
    {
        $options = app(\Sharmindar\Core\User\Repositories\UserRepository::class)
    ...
    {
        $options = app(\Sharmindar\Core\Lead\Repositories\SourceRepository::class)
            ->get(['id as value', 'name as label'])
            ->map(function ($item, $key) {
                $item->disabled = false;
    ...
    {
        $options = app(\Sharmindar\Core\Contact\Repositories\OrganizationRepository::class)
            ->get(['id as value', 'name as label'])
            ->map(function ($item, $key) {
                $item->disabled = false;
    ...
    {
        $options = app(\Sharmindar\Core\Warehouse\Repositories\WarehouseRepository::class)
            ->get(['id as value', 'name as label'])
            ->map(function ($item, $key) {
                $item->disabled = false;

...
namespace Sharmindar\Core\Automation\Helpers\Entity;

use Carbon\Carbon;
use Illuminate\Support\Facades\Mail;
use Sharmindar\Core\Activity\Contracts\Activity as ContractsActivity;
use Sharmindar\Core\Activity\Repositories\ActivityRepository;
use Sharmindar\Core\Admin\Notifications\Common;
use Sharmindar\Core\Attribute\Repositories\AttributeRepository;
use Sharmindar\Core\Automation\Repositories\WebhookRepository;
use Sharmindar\Core\Automation\Services\WebhookService;
use Sharmindar\Core\Contact\Repositories\PersonRepository;
use Sharmindar\Core\EmailTemplate\Repositories\EmailTemplateRepository;
...
class Activity extends AbstractEntity
{
    ...
    public function __construct(protected
        AttributeRepository $attributeRepository, protected
        EmailTemplateRepository $emailTemplateRepository, protected
        LeadRepository $leadRepository, protected
        PersonRepository $personRepository, protected
        ActivityRepository $activityRepository, protected
        WebhookRepository $webhookRepository, protected
    ...
    public function getICSContent(ContractsActivity $activity): string
    {
        $content = [
            'BEGIN:VCALENDAR',
            'VERSION:2.0',
            'PRODID:-//Sharmindar//Sharmindar//EN',
            'BEGIN:VEVENT',

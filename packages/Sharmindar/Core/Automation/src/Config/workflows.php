...
return [
    'trigger_entities' => [
        ...
        'leads' => [
            'name'   => 'Leads',
            'class'  => 'Sharmindar\Core\Automation\Helpers\Entity\Lead',
            'events' => [
                [
        ...
        'activities' => [
            'name'   => 'Activities',
            'class'  => 'Sharmindar\Core\Automation\Helpers\Entity\Activity',
            'events' => [
                [
        ...
        'persons' => [
            'name'   => 'Persons',
            'class'  => 'Sharmindar\Core\Automation\Helpers\Entity\Person',
            'events' => [
                [
        ...
        'quotes' => [
            'name'   => 'Quotes',
            'class'  => 'Sharmindar\Core\Automation\Helpers\Entity\Quote',
            'events' => [
                [

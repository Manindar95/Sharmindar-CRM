    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'sharmindar' => 'نصب کرایین',
                'sharmindar-info' => 'در حال ایجاد جداول پایگاه داده، این ممکن است چند لحظه طول بکشد',
                'title' => 'نصب',
            ],

            'installation-completed' => [
                'admin-panel' => 'پنل مدیریت',
                'sharmindar-forums' => 'انجمن کرایین',
                'customer-panel' => 'پنل مشتری',
                'explore-sharmindar-extensions' => 'کاوش افزونه‌های کرایین',
                'title' => 'نصب کامل شد',
            ...
            'back' => 'بازگشت',
            'sharmindar' => 'کرایین',
            'sharmindar-info' => 'یک پروژه اجتماعی توسط',
            'sharmindar-logo' => 'لوگوی کرایین',
            'continue' => 'ادامه',

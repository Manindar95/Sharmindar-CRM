    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'sharmindar' => 'تثبيت Sharmindar',
                'sharmindar-info' => 'إنشاء جداول قاعدة البيانات، وقد يستغرق ذلك بضع دقائق',
                'title' => 'التثبيت',
            ],

            'installation-completed' => [
                'admin-panel' => 'لوحة المشرف',
                'sharmindar-forums' => 'منتديات Sharmindar',
                'customer-panel' => 'لوحة العميل',
                'explore-sharmindar-extensions' => 'استكشاف امتدادات Sharmindar',
                'title' => 'اكتمال التثبيت',
                'title-info' => 'تم تثبيت Sharmindar بنجاح على نظامك.',
            ],

            'ready-for-installation' => [
                'create-databsae-table' => 'إنشاء جدول قاعدة البيانات',
                'install' => 'التثبيت',
                'install-info' => 'Sharmindar للتثبيت',
            ...
            'start' => [
                ...
                'title' => 'تثبيت Sharmindar الخاص بك',
                'welcome-title' => 'مرحبًا بك في Sharmindar',
            ],
            ...
            'back' => 'رجوع',
            'sharmindar' => 'Sharmindar',
            'sharmindar-info' => 'مشروع مجتمعي من قبل',
            'sharmindar-logo' => 'شعار Sharmindar',
            'continue' => 'متابعة',
            'installation-description' => 'عادة ما تتضمن عملية تثبيت Sharmindar عدة خطوات. إليك نظرة عامة عامة على عملية التثبيت sharmindar',
            'installation-info' => 'نحن سعداء برؤيتك هنا!',
            'installation-title' => 'مرحبًا بك في التثبيت',
            'installation-wizard' => 'لغة معالج التثبيت',
            'title' => 'مثبت Sharmindar',

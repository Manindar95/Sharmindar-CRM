    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'sharmindar' => 'Instalação do Sharmindar',
                'sharmindar-info' => 'Criando as tabelas do banco de dados, isso pode levar alguns momentos',
                'title' => 'Instalação',
            ],

            'installation-completed' => [
                'admin-panel' => 'Painel de Administração',
                'sharmindar-forums' => 'Fórum Sharmindar',
                'customer-panel' => 'Painel do Cliente',
                'explore-sharmindar-extensions' => 'Explorar Extensões Sharmindar',
                'title' => 'Instalação Concluída',
                'title-info' => 'Sharmindar foi instalado com sucesso no seu sistema.',
            ],
            ...
            'start' => [
                ...
                'title' => 'Instalação do Sharmindar',
                'welcome-title' => 'Bem-vindo ao Sharmindar',
            ],
            ...
            'back' => 'Voltar',
            'sharmindar' => 'Sharmindar',
            'sharmindar-info' => 'um projeto comunitário de',
            'sharmindar-logo' => 'Logotipo Sharmindar',
            'continue' => 'Continuar',
            'installation-description' => 'A instalação do Sharmindar geralmente envolve várias etapas. Aqui está uma visão geral do processo de instalação do Sharmindar',
            ...
            'title' => 'Instalador do Sharmindar',
            'sharmindar-team' => 'Sharmindar Team',
        ],
    ],
];

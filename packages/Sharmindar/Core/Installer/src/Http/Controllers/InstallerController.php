...
namespace Sharmindar\Core\Installer\Http\Controllers;
...
use Sharmindar\Core\Installer\Helpers\DatabaseManager;
use Sharmindar\Core\Installer\Helpers\EnvironmentManager;
use Sharmindar\Core\Installer\Helpers\ServerRequirements;
...
class InstallerController extends Controller
{
    ...
    private function smtpConfigSetup()
    {
        ...
        File::put($filePath, 'Your Sharmindar App is Successfully Installed');

                        ...
                        <template v-else>
                            <div class="grid max-h-[400px] overflow-y-auto">
                                <template v-for="project in searchedResults.projects">
                                    <a :href="'{{ route('admin.projects.edit', ':id') }}'.replace(':id', project.id)" class="flex cursor-pointer justify-between gap-2.5 border-b border-slate-300 p-4 last:border-b-0 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-950">
                                        <div class="grid place-content-start gap-0.5">
                                            <p class="text-base font-semibold text-gray-600 dark:text-gray-300">@{{ project.name }}</p>
                                            <p class="text-gray-500 text-xs">@{{ project.description || 'No description' }}</p>
                                        </div>
                                        <span class="text-xs font-semibold">@{{ project.status?.replace('_', ' ') }}</span>
                                    </a>
                                </template>
                            </div>
                            <div class="flex border-t p-3 dark:border-gray-800">
                                <a href="{{ route('admin.projects.index') }}" class="cursor-pointer text-xs font-semibold text-brandColor hover:underline">Explore All Projects</a>
                            </div>
                        </template>
                    </template>
                        ...
                        <template v-else>
                            <div class="grid max-h-[400px] overflow-y-auto">
                                <template v-for="task in searchedResults.tasks">
                                    <a :href="'{{ route('admin.tasks.edit', ':id') }}'.replace(':id', task.id)" class="flex cursor-pointer justify-between gap-2.5 border-b border-slate-300 p-4 last:border-b-0 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-950">
                                        <div class="grid place-content-start gap-0.5">
                                            <p class="text-base font-semibold text-gray-600 dark:text-gray-300">@{{ task.title }}</p>
                                            <p class="text-gray-500 text-xs">@{{ task.description || 'No description' }}</p>
                                        </div>
                                        <div class="grid place-content-center gap-1">
                                            <span class="text-xs font-semibold">@{{ task.status?.replace('_', ' ') }}</span>
                            ...
                            <div class="flex border-t p-3 dark:border-gray-800">
                                <a href="{{ route('admin.tasks.index') }}" class="cursor-pointer text-xs font-semibold text-brandColor hover:underline">Explore All Tasks</a>
                            </div>
                        </template>
                    </template>
                        ...
                        <template v-else>
                            <div class="grid max-h-[400px] overflow-y-auto">
                                <template v-for="client in searchedResults.clients">
                                    <a :href="'{{ route('admin.contacts.organizations.edit', ':id') }}'.replace(':id', client.id)" class="flex cursor-pointer justify-between gap-2.5 border-b border-slate-300 p-4 last:border-b-0 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-950">
                                        <div class="grid place-content-start gap-0.5">
                                            <p class="text-base font-semibold text-gray-600 dark:text-gray-300">@{{ client.name }}</p>
                                            <p class="text-gray-500 text-xs">@{{ client.address || 'No address' }}</p>
                                        </div>
                                    </a>
                                </template>
                            </div>
                            <div class="flex border-t p-3 dark:border-gray-800">
                                <a href="{{ route('admin.contacts.organizations.index') }}" class="cursor-pointer text-xs font-semibold text-brandColor hover:underline">Explore All Clients</a>
                            </div>
                        </template>
                    </template>
                </div>

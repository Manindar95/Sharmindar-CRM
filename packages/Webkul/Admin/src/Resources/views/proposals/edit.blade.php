<x-admin::layouts>
    <x-slot:title>
        @lang('admin::app.proposals.edit.title')
    </x-slot>

    <x-admin::form
        :action="route('admin.proposals.update', $proposal->id)"
        method="PUT"
    >
        <div class="flex flex-col gap-4">
            <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                ...
                <div class="flex items-center gap-x-2.5">
                    ...
                    >
                        @lang('admin::app.proposals.edit.back-btn')
                    </a>
                    ...
                    >
                        @lang('admin::app.proposals.edit.save-btn')
                    </button>
                </div>
            </div>
            ...
            <div class="box-shadow rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group class="flex-1">
                        ...
                        >
                            ...
                            @foreach ($projects as $project)
                                <option value="{{ $project->id }}" {{ $proposal->project_id == $project->id ? 'selected' : '' }}>{{ $project->name }}</option>
                            @endforeach
                        </x-admin::form.control-group.control>
                ...
                <div class="flex gap-4">
                    <x-admin::form.control-group class="flex-1">
                        ...
                        <x-admin::form.control-group.control
                            ...
                            name="person_id"
                            rules="required"
                            :value="$proposal->person_id"
                            :label="trans('admin::app.proposals.create.client')"
                        >
                            <option value="">Select Client</option>
                            @foreach ($persons as $person)
                                <option value="{{ $person->id }}" {{ $proposal->person_id == $person->id ? 'selected' : '' }}>{{ $person->name }}</option>
                            @endforeach
                        </x-admin::form.control-group.control>
                ...
                <div class="flex gap-4">
                    <x-admin::form.control-group class="flex-1">
                        ...
                        <x-admin::form.control-group.control
                            ...
                            name="proposal_date"
                            rules="required"
                            :value="$proposal->proposal_date?->format('Y-m-d')"
                ...
                <div class="flex gap-4">
                    <x-admin::form.control-group class="flex-1">
                        ...
                        >
                            ...
                            <option value="signed" {{ $proposal->status == 'signed' ? 'selected' : '' }}>Signed</option>
                        </x-admin::form.control-group.control>
                    ...
                    <x-admin::form.control-group class="flex-1">
                        ...
                        <x-admin::form.control-group.control
                            ...
                            :value="$proposal->ceo_approved_at?->format('Y-m-d')"
                ...
                <div class="flex gap-4">
                    <x-admin::form.control-group class="flex-1">
                        ...
                        <x-admin::form.control-group.control
                            ...
                            :value="$proposal->manager_approved_at?->format('Y-m-d')"
                    ...
                    <x-admin::form.control-group class="flex-1">
                        ...
                        <x-admin::form.control-group.control
                            ...
                            :value="$proposal->shared_with_client_at?->format('Y-m-d')"
                ...
                <x-admin::form.control-group>
                    ...
                    <x-admin::form.control-group.control
                        ...
                        :value="$proposal->client_signed_at?->format('Y-m-d')"

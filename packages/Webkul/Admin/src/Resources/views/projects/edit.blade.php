                    ...
                    <x-admin::form.control-group class="flex-1">
                        ...
                        >
                            ...
                            @foreach ($persons as $person)
                                <option value="{{ $person->id }}" {{ $project->client_id == $person->id ? 'selected' : '' }}>{{ $person->name }}</option>
                            @endforeach
                        </x-admin::form.control-group.control>
                ...
                <div class="flex gap-4">
                    <x-admin::form.control-group class="flex-1">
                        ...
                        <x-admin::form.control-group.control
                            ...
                            :value="$project->expected_end_date?->format('Y-m-d')"
                    ...
                    <x-admin::form.control-group class="flex-1">
                        ...
                        <x-admin::form.control-group.control
                            ...
                            :value="$project->actual_end_date?->format('Y-m-d')"
                ...
                <div class="flex gap-4">
                    ...
                    <x-admin::form.control-group class="flex-1">
                        ...
                        >
                            ...
                            @foreach ($users as $user)
                                <option value="{{ $user->id }}" {{ $project->owner_id == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                            @endforeach
                        </x-admin::form.control-group.control>
                ...
                <div class="flex gap-4">
                    <x-admin::form.control-group class="flex-1">
                        ...
                        >
                            ...
                            <option value="low" {{ $project->priority === 'low' ? 'selected' : '' }}>@lang('admin::app.projects.create.low')</option>
                            <option value="medium" {{ $project->priority === 'medium' ? 'selected' : '' }}>@lang('admin::app.projects.create.medium')</option>
                            <option value="high" {{ $project->priority === 'high' ? 'selected' : '' }}>@lang('admin::app.projects.create.high')</option>
                        </x-admin::form.control-group.control>
                    ...
                    <x-admin::form.control-group class="flex-1">
                        ...
                        <x-admin::form.control-group.control
                            ...
                            id="team_type"
                            name="team_type"
                            :value="$project->team_type"
                            :label="trans('admin::app.projects.create.team-type')"
                        >
                            <option value="">Select Team</option>
                            <option value="internal" {{ $project->team_type === 'internal' ? 'selected' : '' }}>@lang('admin::app.projects.create.internal')</option>
                            <option value="external" {{ $project->team_type === 'external' ? 'selected' : '' }}>@lang('admin::app.projects.create.external')</option>
                        </x-admin::form.control-group.control>

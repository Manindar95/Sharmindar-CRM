...
return [
    [
        ...
        'key' => 'quotes.assign',
        'name' => 'Assign',
        'route' => ['admin.quotes.assign'],
        'sort' => 5,
    ], [
        'key' => 'quotes.approve',
        'name' => 'Approve',
        'route' => ['admin.quotes.approve'],
        'sort' => 6,
    ], [
        'key' => 'mail',
        ...
        'name' => 'Assign',
        'route' => ['admin.activities.assign'],
        'sort' => 4,
    ], [
        'key' => 'activities.approve',
        'name' => 'Approve',
        'route' => ['admin.activities.approve'],
        'sort' => 5,
    ], [
        ...
        'key' => 'contacts.organizations.export',
        'name' => 'Export',
        'route' => 'admin.contacts.organizations.export',
        'sort' => 4,
    ], [
        'key' => 'products',

...
Route::withoutMiddleware(['user'])->group(function () {
    ...
    Route::controller(SessionController::class)->group(function () {
            Route::prefix('login')->group(function () {
                ...
                Route::get('2fa-challenge', [\Company\Core\Setting\Http\Controllers\TwoFactorController::class , 'showChallengeForm'])->name('admin.2fa.challenge');
                Route::post('2fa-challenge', [\Company\Core\Setting\Http\Controllers\TwoFactorController::class , 'verifyChallenge'])->name('admin.2fa.verify');
            }
            );

...
class ImportDataGrid extends DataGrid
{
    ...
    {
        if (bouncer()->hasPermission('general.settings.data_transfer.imports.import')) {
            $this->addAction([
                'index'  => 'import',
                'icon'   => 'icon-import',
        ...
        if (bouncer()->hasPermission('general.settings.data_transfer.imports.edit')) {
            $this->addAction([
                'index'  => 'edit',
                'icon'   => 'icon-edit',
        ...
        if (bouncer()->hasPermission('general.settings.data_transfer.imports.delete')) {
            $this->addAction([
                'index'  => 'delete',
                'icon'   => 'icon-delete',

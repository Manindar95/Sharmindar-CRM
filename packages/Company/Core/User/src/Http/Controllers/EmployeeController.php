...
namespace Company\Core\User\Http\Controllers;
...
use Company\Core\User\Models\EmployeeProfile;
use Company\Core\User\Models\UserMeta;
...
class EmployeeController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datagrid(\Company\Core\User\DataGrids\EmployeeDataGrid::class)->process();
        }

    ...
    [
        ...
        'fields' => [
            ...
            [
                ...
                'type' => 'select',
                'default' => 'UTC',
                'options' => 'Company\Core\Settings\Helpers\Core@timezones',
            ],
            [
                'name' => 'currency',
                'title' => 'Currency',
                'type' => 'select',
                'default' => 'USD',
                'options' => 'Company\Core\Settings\Helpers\Core@currencies',
            ],
            [
                'name' => 'language',
                'title' => 'Language',
                'type' => 'select',
                'default' => 'en',
                'options' => 'Company\Core\Settings\Helpers\Core@locales',
            ]
        ],
    ],
